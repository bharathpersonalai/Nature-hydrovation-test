...
export default function Products() {
  ...
  return (
    <div className="min-h-screen pt-20">
      ...
      >
        <div className="absolute inset-0 bg-gray-900 opacity-20" aria-hidden="true"></div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                description: "All certifications and safety standards met"
              },
              {
                title: "Maintenance Support",
                description: "Regular service and filter replacements"
              },
              {
              ...
              <div key={item.title} className="bg-gradient-to-br from-cyan-50 to-teal-50 rounded-xl p-6 border-2 border-cyan-200">
                <CheckCircle className="h-10 w-10 text-cyan-600 mb-4" aria-hidden="true" />
