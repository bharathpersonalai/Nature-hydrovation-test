...
  // 1. DUPLICATE THE ITEMS for the infinite loop
...
      const halfWidth = scrollWidth / 2; // This is the width of your original list

      // Apply easing
      currentScroll += (scrollRef.current - currentScroll) * scrollEase;

      // 2. INFINITE LOOP LOGIC
      // If scrolling right and pass the end of the first list
...
          >
            <div 
              className="relative group overflow-hidden bg-white rounded-2xl"
            >
              <img
                src={item.image}
                alt={item.text}
...
              />
        _     <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <p 
