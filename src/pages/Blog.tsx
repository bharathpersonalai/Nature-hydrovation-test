  ...
  const articles = [
    {
      ...
      excerpt:
        "Discover why pH matters and how alkaline water supports your body's natural balance. Learn about the science behind optimal hydration and mineral absorption.",
      date: "2024-10-15",
      readTime: "8 min read",
    ...
    },
    {
      ...
      excerpt:
        "Explore how volcanic stones and marine minerals transform ordinary water into a wellness powerhouse. The natural filtration process explained.",
      date: "2024-10-10",
      readTime: "6 min read",
      category: "Technology",
    ...
    },
    {
      ...
      excerpt:
        "Essential maintenance tips to ensure your water purification system continues delivering premium quality water year after year.",
      date: "2024-10-05",
      readTime: "5 min read",
    ...
    },
    {
      ...
      excerpt:
        "A comprehensive comparison of water purification technologies. Understand the differences and make an informed decision for your family's health.",
      date: "2024-09-28",
    ...
    },
    {
      ...
      excerpt:
        "The connection between water quality and overall wellness. Learn how mineral-rich water impacts digestion, energy levels, and cellular health.",
      date: "2024-09-20",
      readTime: "7 min read",
      category: "Health Science",
    ...
    },
    {
      ...
      excerpt:
        "Essential factors to consider before purchasing. Certifications, filtration technology, maintenance costs, and long-term value explained.",
      date: "2024-09-12",
      readTime: "9 min read",
      category: "Buyer Guide",
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
              ...
              <p className="text-gray-600 mb-4">
                Learn how alkaline mineral water supports your body's natural
                processes and enhances overall wellness.
              </p>
              <button
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
              ...
              <p className="text-gray-600 mb-4">
                Understand the science behind volcanic mineral filtration and
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Subscribe to receive the latest articles on water wellness, health
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-cyan-600 to-teal-700 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-6">
            Have Questions About Water Purification?
          </h2>
          <p className="text-xl mb-8 text-cyan-50">
            Our water wellness experts are here to help you understand the best
